...
<div class="main-content app-content mt-0">
    ...
    <div class="card-body">
        <div class="btn-list">
            ...
            <a href="javascript:void(0)" class="btn btn-success bg-success-gradient notice1" id="successBtn" style="display: none;">Success</a>
        </div>
    </div>
                                ...
                                <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form method="POST" action="{{ route('admin.feedback.toggle', $feedback->id) }}">
                                                        @csrf
                                                        @method('PATCH')

                                                        <div class="material-switch pull-right">
                                                            <input id="switch-{{ $feedback->id }}" name="display" type="checkbox" onchange="this.form.submit()" {{ $feedback->display ? 'checked' : '' }} />
                                                            <label for="switch-{{ $feedback->id }}" class="label-success"></label>
                                                        </div>
                                                    </form>
